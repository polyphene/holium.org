      ...
      <div className={styles.body}>
        <div className={styles.cardsWrapper}>
          <Card title={'Big title'} image={
            <StaticImage src={"https://picsum.photos/1000/800"} alt={"placeholder"}
                         className={cardStyles.image}
            />
          }>
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pretium nisl egestas sit odio auctor sed ornare ac sem non est duis elit ac.
          </Card>
          <Card title={'Big title'} image={
            <StaticImage src={"https://picsum.photos/800/1000"} alt={"placeholder"}
                         className={cardStyles.image}
            />
          }>
            Pretium nisl egestas sit odio auctor sed ornare ac sem non est duis elit ac.
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pretium nisl egestas sit odio auctor sed ornare ac sem non est duis elit ac.
          </Card>
        </div>
      </div>
